...
import static utils.lists.ArrayOrderedList.*;
...
public class SignupController {
    ...
    ArrayList user;
    @FXML
    ArrayIndexedList ArrayIndexedList;
    ...
    public void createAccount() throws IOException {
        ...
        if (pw.getText().equals(confirmpw.getText())) {
            failSamePassword.setVisible(false);
        }
        ...
        if (ArrayIndexedList.contains(uname.getText())) {
        ...
        if (!firstName.getText().equals("") && !lastName.getText().equals("") && !dob.getText().equals("")
                ...
                && (!ArrayIndexedList.contains(uname.getText()))
                ) {

            failPasswordFormat.setVisible(false);
            failSamePassword.setVisible(false);
            failEmailFormat.setVisible(false);
            failFieldsNotComplete.setVisible(false);
            failUsernameExists.setVisible(false);
